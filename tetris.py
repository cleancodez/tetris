...
def main():
    ...
    while run:
        ...
        grid = create_grid(locked_positions)
        fall_time += clock.get_rawtime() #will run same speed on all computers
        ...
        if change_piece:
            for pos in shape_positions:
                ...
                #locked_positions no piece longer moving - dicitionary with a key of a position and a value of a color   
    ...
    draw_text_middle("You Suck! Try Again.", 40, (255,255,255), win)
    pygame.display.update()
